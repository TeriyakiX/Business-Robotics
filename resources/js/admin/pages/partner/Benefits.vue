...
.br-admin-icon-option {
    width: 40px;
    height: 40px;
    border: 2px solid rgba(0, 180, 230, 0.2);
    border-radius: 8px;
    background: rgba(0, 0, 0, 0.3);
    color: #5A7A95;
    cursor: pointer;
...
.br-admin-icon-option:hover {
    border-color: rgba(0, 207, 255, 0.5);
    color: #E8F0F8;
}

.br-admin-icon-option.active {
    border-color: #00CFFF;
    background: rgba(0, 207, 255, 0.15);
    color: #00CFFF;
}
