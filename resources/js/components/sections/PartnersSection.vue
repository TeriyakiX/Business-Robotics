        ...
        <div class="container">
            ...
            <div class="partners-grid">
                ...
                <div class="partner-card partner-card-dev">
                    ...
                    <div class="partner-badge" style="background: rgba(0,207,255,0.08); border: 1px solid rgba(0,207,255,0.22); color: #005FAA;">
...
.partner-glow {
    ...
    width: 120px;
    height: 120px;
    background: radial-gradient(circle at top right, rgba(0, 207, 255, 0.08), transparent 70%);
    pointer-events: none;
}
...
.partner-percent-dev {
    background: linear-gradient(90deg, #003d8a, #00CFFF, #0079cc, #00CFFF);
    background-size: 300% auto;
    -webkit-background-clip: text;
    background-clip: text;
    -webkit-text-fill-color: transparent;
    animation: pctShimmer 3s linear infinite;
}

.partner-percent-sub {
    background: linear-gradient(90deg, #4c1d95, #a855f7, #7C3AED, #a855f7);
    background-size: 300% auto;
    -webkit-background-clip: text;
    background-clip: text;
    -webkit-text-fill-color: transparent;
...
.partner-tag:hover {
    ...
    box-shadow: 0 4px 14px rgba(0, 207, 255, 0.2);
}
...
.partner-earn-card:hover {
    ...
    box-shadow: 0 20px 52px rgba(0, 80, 200, 0.15);
...
.partner-step-num {
    ...
    flex-shrink: 0;
    position: relative;
    animation: stepNumPulse 2.5s ease infinite;
}
...
.partner-step-num::after {
    content: '';
    position: absolute;
    inset: -4px;
    border-radius: 50%;
    border: 2px solid rgba(0, 207, 255, 0.45);
    animation: pulseRingOutline 2s ease infinite;
    pointer-events: none;
}

@keyframes pulseRingOutline {
...
.partner-why-card:hover {
    ...
    box-shadow: 0 6px 24px rgba(0, 80, 200, 0.1);
}
...
.partner-why-card:hover .partner-why-icon {
...
.partner-cta {
    ...
    background: white;
    border: 1px solid rgba(0, 80, 180, 0.12);
    box-shadow: 0 4px 32px rgba(0, 40, 120, 0.08);
    position: relative;
    overflow: hidden;
}
...
.partner-cta::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(ellipse at 20% 20%, rgba(0, 207, 255, 0.09) 0%, transparent 58%), radial-gradient(ellipse at 80% 75%, rgba(0, 95, 170, 0.06) 0%, transparent 55%);
    animation: floatGlow 5s ease infinite;
    pointer-events: none;
}
